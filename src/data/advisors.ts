...
export const createAdvisors = (scenarioType: string): Advisor[] => {
  ...
  if (scenarioType === 'real-attack') {
    ...
    baseAdvisors[1].statements = [
      ...
      { timestamp: 250, content: 'Mr. President... ich weiß, dass ich vor wenigen Minuten eine begrenzte Antwort empfohlen habe. Doch unsere Analysten melden nun, dass einzelne Sensorlinien nicht sauber korrelieren. Ich erinnere an September 1983 – Oberst Petrow rettete die Welt, weil er trotz Druck weitere Bestätigung verlangte. Vielleicht schulden wir der Geschichte zumindest noch eine letzte Verifikation.', confidence: 'medium' },
